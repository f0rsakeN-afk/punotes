      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {semesters.map((sem, i) => (
          <Link
            ...
            className="group flex flex-col justify-between p-5 rounded-xl border border-border/60 bg-background hover:border-border hover:shadow-md hover:bg-muted/20 transition-all duration-150 aspect-square animate-in fade-in slide-in-from-bottom-4 duration-300"
