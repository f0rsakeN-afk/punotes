...
const PDF: React.FC = () => {
  ...
  return (
    <>
      {" "}
      <SEO
      title={`${subject} - ${branch} ${semester} | PU Notes`}
              description={`Download ${subject} study materials for ${branch} ${semester} at Purbanchal University`}
              keywords={`${subject}, ${branch}, ${semester}, engineering notes, PUSOE, study materials`}
      />
